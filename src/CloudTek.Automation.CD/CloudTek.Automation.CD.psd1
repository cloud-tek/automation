#
# Module manifest for module 'CloudTek.Automation.CD'
#
...
@{
  ...
  GUID = 'd10fba21-0d35-4f81-8739-ce496c63b73f'
  ...
  Description = 'This package contains reusable powershell automation for continuous delivery'
  ...
  RequiredModules = @(
    @{
      ModuleName = "CloudTek.Automation.ArgoCD";
      ModuleVersion = "0.0.0"
    },
    @{
      ModuleName = "CloudTek.Automation.Git";
      ModuleVersion = "0.0.0"
    },
    @{
