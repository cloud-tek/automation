#
# Module manifest for module 'CloudTek.Automation.ArgoCD'
#
...
@{
  ...
  GUID = '053e7ac7-4bd4-4eb0-87be-b575bce813ad'
  ...
  Description = 'This package contains core utilities to support other automation modules'
  ...
  NestedModules = @("./Utilities.psm1")

  # Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
  FunctionsToExport = @("Get-Command", "Get-Folder")
