...
@{
  ...
  GUID = '69768057-d4ed-4b96-88f3-724a237667b4'
  ...
  Description = 'This package contains reusable powershell automation for executing against Git.'
  ...
  FunctionsToExport = @("Get-GitRepository", "Invoke-GitCommit")
